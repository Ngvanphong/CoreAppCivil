        ...
        public async Task Seed()
        {
            ...
            if (_context.Functions.Count() == 0)
            {
                _context.Functions.AddRange(new List<Function>()
                {
                    ...
                    new Function() {Id = "PANTNER",Name = "Thương hiệu",ParentId = "UTILITY",SortOrder = 5,Status = Status.Active,URL = "/main/pantner/index",IconCss = "fa-clone"  },
            ...
            if (_context.ProductCategories.Count() == 0)
            {
                List<ProductCategory> listProductCategory = new List<ProductCategory>()
                {
                    new ProductCategory() { Name="Áo nam",SeoAlias="ao-nam",ParentId = null,Status=Status.Active,SortOrder=1,
                        ...
                        {
                            new Product(){Name = "Sản phẩm 1",SeoAlias = "san-pham-1",Status = Status.Active,Content="Content 1"},                            
                        }
                    },
                    new ProductCategory() { Name="Áo nữ",SeoAlias="ao-nu",ParentId = null,Status=Status.Active ,SortOrder=2,
                        Products = new List<Product>()
                        {
                            new Product(){Name = "Sản phẩm 6",SeoAlias = "san-pham-6",Status = Status.Active,Content="Content 6"},                           
                        }},
